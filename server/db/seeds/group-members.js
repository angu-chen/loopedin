...
export async function seed(knex) {
  ...
  await knex('group_members').insert([
    ...
    { id: 4, group_id: 1, user_id: 6 },
    { id: 5, group_id: 2, user_id: 2 },
    { id: 6, group_id: 2, user_id: 4 },
    { id: 7, group_id: 3, user_id: 3 },
    { id: 8, group_id: 3, user_id: 5 },
    { id: 9, group_id: 4, user_id: 6 },
    { id: 10, group_id: 4, user_id: 1 },
  ])
}
