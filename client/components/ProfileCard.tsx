        ...
        <div className="rounded-xl border border-solid border-blue-950 bg-blue-100 pb-6 ">
            ...
            <div className="flex w-full justify-center">
              <div className="relative">
                <img
                  ...
                  className="-ml-18 absolute -m-16 max-w-[150px] rounded-full align-middle lg:-ml-16 dark:border-gray-800 dark:shadow-xl"
                />
              </div>
            </div>
          </div>
          ...
          <div className="relative h-6 translate-y-6 overflow-hidden rounded-b-xl">
            <div className="absolute flex -space-x-12 rounded-b-2xl">
              <div className="z-10 h-8 w-36 skew-x-[35deg] transform bg-blue-950/90 transition-colors delay-75 duration-200 group-hover:bg-red-950/90"></div>
              <div className="z-20 h-8 w-28 skew-x-[35deg] transform bg-blue-900/90 transition-colors delay-100 duration-200 group-hover:bg-blue-950/90"></div>
              <div className="z-30 h-8 w-28 skew-x-[35deg] transform bg-blue-200/90 transition-colors delay-150 duration-200 group-hover:bg-blue-900/90"></div>
              <div className="z-40 h-8 w-28 skew-x-[35deg] transform bg-blue-100/90 transition-colors delay-200 duration-200 group-hover:bg-blue-300/90"></div>
              <div className="z-50 h-8 w-28 skew-x-[35deg] transform bg-white/90 transition-colors delay-300 duration-200 group-hover:bg-blue-200/90"></div>
            </div>
          </div>
        </div>
      </Link>
