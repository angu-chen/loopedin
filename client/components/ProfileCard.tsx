...
export default function ProfileCard({ user }: Props) {
  return (
    // <div className="group relative mx-auto mb-6 mt-6 w-full min-w-0 max-w-md break-words rounded-xl border bg-white shadow-2xl md:max-w-sm dark:border-gray-700 dark:bg-gray-800">
    //   <img
    ...
    //     {user.username}
    //   </div>
    //   <div className="mt-2 text-center text-sm font-light">{user.fullname}</div>
    //   <div className="text-center text-lg font-normal">{user.location}</div>
    // </div>
      ...
      <div className="pb-6">
            ...
            <div className="flex justify-center pb-0 pt-8 lg:pt-4">
              <div className="flex space-x-2">
                <a
                  ...
                  href="#"
                  rel="noopener"
                  aria-label={`${user.fullname} on  Twitter`}
                  target="_blank"
                >
                  <svg
                ...
                <a
                  className="ring-primary -m-1 p-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2"
                  href="#"
                  aria-label={`${user.fullname} on  Github`}
                >
                  <svg
                    className="h-6 w-6 overflow-visible fill-current"
                    aria-hidden="true"
                ...
                <a
                  className="ring-primary -m-1 p-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2"
                  href="#"
                  aria-label={`${user.fullname} on  Linkedin`}
                >
                  <svg
                    className="h-6 w-6 overflow-visible fill-current"
                    aria-hidden="true"
                ...
                <a
                  className="ring-primary -m-1 p-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2"
                  href="#"
                  aria-label={`${user.fullname} on  Instagram`}
                >
                  <svg
                    className="h-6 w-6 overflow-visible fill-current"
                    aria-hidden="true"
                ...
                <a
                  ...
                  href="#"
                  rel="noopener"
                  aria-label={`${user.fullname} on  Youtube`}
                  target="_blank"
                >
                  <svg
                    className="h-6 w-6 overflow-visible fill-current"
        ...
        <div className="relative h-6 translate-y-6 overflow-hidden rounded-b-xl">
          <div className="absolute flex -space-x-12 rounded-b-2xl">
            <div className="z-10 h-8 w-36 skew-x-[35deg] transform bg-amber-400/90 transition-colors delay-75 duration-200 group-hover:bg-amber-600/90"></div>
            <div className="z-20 h-8 w-28 skew-x-[35deg] transform bg-amber-300/90 transition-colors delay-100 duration-200 group-hover:bg-amber-500/90"></div>
            <div className="z-30 h-8 w-28 skew-x-[35deg] transform bg-amber-200/90 transition-colors delay-150 duration-200 group-hover:bg-amber-400/90"></div>
            <div className="z-40 h-8 w-28 skew-x-[35deg] transform bg-amber-100/90 transition-colors delay-200 duration-200 group-hover:bg-amber-300/90"></div>
            <div className="z-50 h-8 w-28 skew-x-[35deg] transform bg-amber-50/90 transition-colors delay-300 duration-200 group-hover:bg-amber-200/90"></div>
          </div>
        </div>
      </div>
    </div>
